...
public class MessageHandler {
    ...
    private CommandParts parseCommand(String userInput) {
        ...
        if (trimmedInput.contains(" ")) {
            int firstIndex = trimmedInput.indexOf(" ");
            String command = trimmedInput.substring(0, firstIndex);
            String parameter = trimmedInput.substring(firstIndex + 1).trim();
            return new CommandParts(command, parameter);
        } else {
            return new CommandParts(trimmedInput, "");
        }
    }
    ...
    /**
     * Возвращает приветственное сообщение при старте бота.
     * Содержит описание возможностей и список доступных команд.
     *
     * @return многострочное приветственное сообщение
     */
     ...
     * Демонстрирует полный workflow работы с ботом на практических примерах.
     *
     * @return многострочное справочное сообщение с примерами
     */
